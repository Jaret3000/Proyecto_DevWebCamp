...
class Evento extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id',
    'dia_id', 'hora_id', 'ponente_id'];
    ...
    public function __construct($args = []){
        ...
        $this->categoria_id = $args['nombre'] ?? '';
        $this->dia_id = $args['nombre'] ?? '';
        $this->hora_id = $args['nombre'] ?? '';
        $this->ponente_id = $args['nombre'] ?? '';
    }
