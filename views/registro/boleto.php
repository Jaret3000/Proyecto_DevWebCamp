<main class="pagina">
    ...
    <p class="pagina__descripcion">Tu boleto - Te recomendamos almacenarlo ya que se te pedira ese dia</p>
    ...
    <div class="boleto-virtual">
        ...
        boleto--acceso">
            <div class="boleto__contenido">
                ...
                <p class="boleto__nombre"><?php echo $registro->usuario->nombre . " " . 
                $registro->usuario->apellido; ?></p>
            </div>
