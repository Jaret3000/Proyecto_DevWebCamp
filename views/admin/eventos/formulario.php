<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="dia">Dia del evento</label>
    ...
    <div id="horas" class="formulario__campo">
        <label class="formulario__label">Hora del evento</label>

        <ul id="horas" class="horas">
            <?php foreach($horas as $hora){ ?>
                <li data-hora-id="<?php echo $hora->id; ?>" 
                class="horas__hora horas__hora--deshabilitada"><?php echo $hora->hora; ?></li>
            <?php } ?>
        </ul>
