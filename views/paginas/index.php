...
<section class="speakers">
    ...
    <?php foreach($ponentes as $ponente) { ?>
        <div <?php aos_animacion(); ?> class="speaker">
            <picture>
                <source srcset="/img/speakers/<?php echo $ponente->imagen; ?>.webp" 
                    type="image/webp">
                <source srcset="/img/speakers/<?php echo $ponente->imagen; ?>.png" 
                    type="image/png">
                <img class="speaker__imagen" loading="lazy"
            ...
            <div class="speaker__informacion">
                ...
                <nav class="speaker-sociales">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->facebook; ?>" 
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->twitter; ?>" 
                    class="speaker-sociales__enlace">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->youtube; ?>" 
                    class="speaker-sociales__enlace">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->instagram; ?>" 
                    class="speaker-sociales__enlace">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->tiktok; ?>" 
                    class="speaker-sociales__enlace">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $redes->github; ?>" 
                    class="speaker-sociales__enlace">
