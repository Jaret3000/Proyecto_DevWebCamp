    ...
    public static function crear(Router $router) { 
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') { 
            ...
            if(!empty($_FILES['imagen']['tmp_name'])) { 
                ...
                $nombreImagen = md5(uniqid(rand(), true)); $_POST['imagen'] = $nombreImagen; 
            } 
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') { 
            ...
            if(empty($alertas)) { 
                ...
                if(isset($nombreImagen)) {
                    ...
                    if(file_exists($carpetaImagenes . '/' . $ponente->imagen_actual . '.png')) {
                        unlink($carpetaImagenes . '/' . $ponente->imagen_actual . '.png');
                    }
                    if(file_exists($carpetaImagenes . '/' . $ponente->imagen_actual . '.webp')) {
