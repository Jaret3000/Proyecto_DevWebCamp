...
class Paginacion {
    ...
    public function enlace_anterior(){
        ...
        if($this->pagina_anterior()){
            ...
            href=\"?page={$this->pagina_anterior()}\">&laquo Anterior</a>";
        }
        return $html;
    }
    ...
    public function enlace_siguiente(){
        ...
        if($this->pagina_siguiente()){
            $html .= "<a class=\"paginacion__enlace paginacion__enlace--texto\" 
            href=\"?page={$this->pagina_siguiente()}\">Siguiente &raquo;</a>";
        }
        return $html;
    }
    ...
    public function numeros_paginas(){
        ...
        for($i = 1; $i <= $this->total_paginas(); $i++){
            if($i === $this->pagina_actual){
                $html .= "<span class=\"paginacion__enlace paginacion__enlace--actual\"></span>";
            } else{
